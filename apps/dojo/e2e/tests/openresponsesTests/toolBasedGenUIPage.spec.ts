...
const pageURL =
  "/openresponses/feature/tool_based_generative_ui";

test('[OpenResponses] Haiku generation and display verification', async ({
  page,
}) => {
...
test('[OpenResponses] Haiku generation and UI consistency for two different prompts', async ({
  page,
}) => {
  await page.goto(pageURL);
