...
| [Google ADK](https://google.github.io/adk-docs/get-started/) | Supported | [Docs](https://docs.copilotkit.ai/adk), [Demos](https://dojo.ag-ui.com/adk-middleware) |
...
| Framework | Status | AG-UI Resources |
| --------- | ------ | --------------- |
| [Mastra](https://mastra.ai/) | Supported | [Docs](https://docs.copilotkit.ai/mastra/), [Demos](https://dojo.ag-ui.com/mastra) |
...
| [Agno](https://github.com/agno-agi/agno) | Supported | [Docs](https://docs.copilotkit.ai/agno/), [Demos](https://dojo.ag-ui.com/agno) |
...
| -------- | ------ | --------------- | ------------ |
| [A2A](https://a2a.org/) | Supported | [Docs](https://docs.copilotkit.ai/a2a-protocol) | Partnership |
