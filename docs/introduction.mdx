...
AG-UI is one of three prominent open [agent interaction protocols](./agent-interaction-protocols).
...
| **Agent ↔ Agent** | **A2A** | Open standard (originated by Google) which defines how agents coordinate and share work across distributed agentic systems. |
