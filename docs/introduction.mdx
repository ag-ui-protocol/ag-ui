...
| [OpenAI Agents SDK](https://openai.github.io/openai-agents-python/) | Supported | [Integration](https://github.com/ag-ui-protocol/ag-ui/tree/main/integrations/openai-agents), [Demos](https://dojo.ag-ui.com/openai-agents-python/feature/tool_based_generative_ui) |
