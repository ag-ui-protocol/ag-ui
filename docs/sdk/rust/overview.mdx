...
A proposed unified `ag-ui` SDK is available for review alongside the existing
packages. See the [migration proposal](/sdk/rust/migration-proposal) for its scope,
local setup, and API differences. The existing packages below remain unchanged.
