...
description: "Understanding how AG-UI fits within the broader ecosystem of agent interaction protocols"
---
...
These three agent interaction protocols are complementary and have distinct technical goals; a single agent can and often does use all 3 simultaneously.
...
Recently several [generative ui specs](./concepts/generative-ui-specs) have been released which allow agents to deliver UI widgets through the interaction protocols.
