...
This section contains draft changes being considered for the AG-UI protocol.
These proposals are under internal review and may be modified or withdrawn
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    iconType="light"
  >
    Token usage tracking per completed step for cost visibility and budget
    enforcement
  </Card>
</CardGroup>
