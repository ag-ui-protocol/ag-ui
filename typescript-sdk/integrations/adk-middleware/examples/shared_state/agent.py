...
def create_recipe_agent():
    """
    Create the recipe generation agent with ADK.
    
    Returns:
        LlmAgent: The configured recipe agent
    """
    
    # Create the generate_recipe tool
    # recipe_tool = FunctionDeclaration(
    ...
    #                         "type": "object",
    #                         "properties": {
    #                             "icon": {"type": "string", "description": "The icon emoji of the ingredient"},
    #                             "name": {"type": "string"},
    #                             "amount": {"type": "string"}
    #                         }
    #                     },
    ...
    #                 }
    #             },
    #             "required": ["skill_level", "ingredients", "instructions"]
    #         }
    #     }
    # )
    
    # Create the agent with system instruction
    agent = LlmAgent(
        name="RecipeAgent",
