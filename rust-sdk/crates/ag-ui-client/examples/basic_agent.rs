...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("Running agent with simple subscriber...");
    ...
    FwdPropsT: FwdProps,
{
    async fn on_run_initialized(
        ...
        println!("Run initialized with {} messages", params.messages.len());
    ...
    async fn on_text_message_content_event(
        ...
        println!("Current buffer: {}", text_message_buffer);
        Ok(AgentStateMutation::default())
    }
    ...
    async fn on_text_message_end_event(
        ...
        println!("Final message: {}", text_message_buffer);
        Ok(AgentStateMutation::default())
    }
    ...
    async fn on_tool_call_args_event(
        ...
        println!("Partial args: {:?}", partial_tool_call_args);
        Ok(AgentStateMutation::default())
    }
    ...
    async fn on_messages_changed(
        ...
        println!("Messages changed: {} messages", params.messages.len());
        Ok(())
    }
    ...
    async fn on_new_tool_call(
        ...
        println!("New tool call: {:?}", tool_call);
        Ok(())
    }
}
