...
def create_tool_based_generative_ui_adapter(cwd: str) -> ClaudeAgentAdapter:
    ...
    Example frontend tool (provided by client):
        {
            "name": "generate_haiku",
            "description": "Display a haiku to the user",
            "parameters": {
                "type": "object",
                "properties": {
                    "haiku": {"type": "string", "description": "The haiku text"}
                }
            }
        }
    ...
    2. Client receives events and renders the haiku component
    ...
    Returns:
        Configured ClaudeAgentAdapter that works with frontend tools.
    """
