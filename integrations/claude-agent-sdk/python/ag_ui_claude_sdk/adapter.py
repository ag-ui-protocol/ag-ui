    ...
    async def run(self, input_data: RunAgentInput) -> AsyncIterator[BaseEvent]:
        ...
        try:
            ...
            if run_result.get("is_error"):
                ...
                # Remember the Claude SDK session_id so a subsequent
                # interrupt-resume run can seed
                # build_options(resume_session_id=...) and re-fire the frozen
                # deferred call. Only meaningful when the interrupt contract is
