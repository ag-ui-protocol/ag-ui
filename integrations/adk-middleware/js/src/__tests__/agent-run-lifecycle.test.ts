...
describe("ADKJSAgent run lifecycle and configuration", () => {
  it("declares its own protocol version on RUN_STARTED", async () => {
  ...
  it("names the frontend tool calls it left unanswered", async () => {
    // Frontend tools are long-running: the call ends the run unanswered.
