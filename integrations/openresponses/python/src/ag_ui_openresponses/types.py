...
@dataclass
class MoltbotProviderConfig:
    """Moltbot-specific configuration extensions.

    Attributes:
        agent_id: Agent ID for routing (alternative to model prefix).
                  Maps to x-moltbot-agent-id header.
        session_key: Session key for conversation continuity.
                     Maps to x-moltbot-session-key header.
    """
...
class OpenResponsesAgentConfig:
    ...
    Attributes:
        ...
        default_model: Default model identifier. Provider-specific formats:
                       ...
                       - Moltbot: "moltbot:main", "moltbot:work" (agent routing)
        ...
        moltbot: Moltbot-specific configuration.
    ...
    moltbot: MoltbotProviderConfig | None = None
