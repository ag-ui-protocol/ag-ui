...
- **NEW**: Initial implementation of OpenResponses AG-UI integration
  ...
  - Provider auto-detection for OpenAI, Azure OpenAI, Hugging Face, and OpenClaw from base URL
  ...
  - Configurable provider settings including Azure-specific and OpenClaw-specific options
