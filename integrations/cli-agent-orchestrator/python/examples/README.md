...
Serves four features — `agentic_chat`, `shared_state`, `human_in_the_loop`, and
the flagship `interrupt` — on port **8027** (`/health`, CORS). See the
...
Next compiles routes on first request, so warm the four feature routes **and**
