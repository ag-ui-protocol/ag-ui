...
): ThinkingStartEvent => ({ type: EventType.THINKING_START, ...props });
...
): ActivityDeltaEvent => ({ type: EventType.ACTIVITY_DELTA, ...props });
...
): RunStartedEvent => ({ type: EventType.RUN_STARTED, ...props });
...
): ReasoningMessageStartEvent => ({ type: EventType.REASONING_MESSAGE_START, ...props });
...
): ReasoningMessageContentEvent => ({ type: EventType.REASONING_MESSAGE_CONTENT, ...props });

/** Creates a REASONING_MESSAGE_END event. */
export const createReasoningMessageEndEvent = (
  props: ReasoningMessageEndEventProps,
): ReasoningMessageEndEvent => ({ type: EventType.REASONING_MESSAGE_END, ...props });
...
): ReasoningMessageChunkEvent => ({ type: EventType.REASONING_MESSAGE_CHUNK, ...props });

/** Creates a REASONING_END event. */
export const createReasoningEndEvent = (
  props: ReasoningEndEventProps,
): ReasoningEndEvent => ({ type: EventType.REASONING_END, ...props });
...
): ReasoningEncryptedValueEvent => ({ type: EventType.REASONING_ENCRYPTED_VALUE, ...props });
