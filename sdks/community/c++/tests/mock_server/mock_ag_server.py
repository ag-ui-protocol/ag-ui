...
class AGUIEvent:
    ...
    @staticmethod
    def text_message_chunk(messageId="msg_001", content=""):
        return {
    ...
    @staticmethod
    def tool_call_chunk(toolCallId="tool_001", arguments="{}"):
        return {
    ...
    @staticmethod
    def tool_call_result(toolCallId="tool_001", result=""):
        return {
    ...
    @staticmethod
    def run_finished(runId="run_001", result=None):
        return {
            "type": "RUN_FINISHED",
            "runId": runId,
    ...
    @staticmethod
    def step_started(stepId="step_001"):
        return {
            "type": "STEP_STARTED",
            "stepId": stepId
        }
    ...
    @staticmethod
    def step_finished(stepId="step_001"):
        return {
            "type": "STEP_FINISHED",
            "stepId": stepId
        }
